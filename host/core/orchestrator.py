"""Central orchestrator for the cognitive audio pipeline."""
...
class CognitiveOrchestrator:
    ...
    def handle_interrupt(self):
        ...
        if dual_tts_manager.is_speaking_active:
            logger.warning(
                "INTERRUPT EVENT RECEIVED! Aborting current generation and TTS playback."
            )
    ...
    async def start(self):
        ...
        stt_task = asyncio.create_task(
            stt_worker(self.segment_queue, self.transcriber, self.text_queue)
        )
