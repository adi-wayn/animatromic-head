"""UDP receiver and jitter buffer for audio streams."""
...
from protocol.messages import AUDIO_CHUNK_SIZE_BYTES, PORT_AUDIO_UPLINK
...
async def start_udp_audio_listener(audio_queue: asyncio.Queue) -> asyncio.BaseTransport:
    ...
    jitter_buffer = JitterBuffer(
        ptime_ms=32, max_jitter_ms=100, packet_size_bytes=AUDIO_CHUNK_SIZE_BYTES
    )
