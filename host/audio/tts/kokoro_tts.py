...
class KokoroTTSStrategy(TTSStrategy):
    ...
    def __init__(self, voice: str = "am_echo"):
        ...
        if not os.path.exists(self.model_path):
            ...
            urllib.request.urlretrieve("https://github.com/thewh1teagle/kokoro-onnx/releases/download/model-files-v1.1/kokoro-v1.0.onnx", self.model_path)
        if not os.path.exists(self.voices_path):
            logger.info("Downloading Kokoro voices metadata...")
            urllib.request.urlretrieve("https://github.com/thewh1teagle/kokoro-onnx/releases/download/model-files-v1.1/voices-v1.0.bin", self.voices_path)
        ...
        import platform
        espeak_config = None
        if platform.system() == "Darwin" and os.path.exists("/opt/homebrew/lib/libespeak-ng.1.dylib"):
